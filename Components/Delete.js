...
export default function CustomizedDialogs(props) {
  ...
  const handleClickDelete = async () =>
  {
      ...
      {
          param.append("doc_id",props.selected[i])
      }
      var request = {params:param}
      await axios.post("http://localhost:8080/Summer_Internship_Backend/delRecord",null,request)
      props.setSelected([])
      setOpen(false)
  }
  ...
  return (
    <div>
        {/* outer button */}
      <Button className={classes.delete} style={{color:props.selected.length===0 ? '#97A1A9': "white"}} onClick={handleClickOpen}
        ...
        <DialogActions>
          <div>
            <Grid container spacing={2}>
              ...
              <Grid item>
                <Button variant="outlined" color="primary" className={classes.buttonSaveColor} onClick={handleClickDelete}>
                  Delete
                </Button>
              </Grid>
            </Grid>
